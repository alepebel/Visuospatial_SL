...
def mainexp_subject_info(version): # loading staircase subject data   
    ...
    try:  # try to get a previous parameters file           
        ...
        # present a dialogue to change params    
        sdataDlg= gui.DlgFromDict(expInfo['subjInfo'], title='Working memory test', fixed=['ExpVersion'], order = [ 'ExpVersion', 'observer']) # fixed=['dateStr']    
        ...
        if myDlg.OK:  
            ...
            # present a dialogue to change params            
            gui.DlgFromDict(subjInfo, title='Working memory test', fixed=['ExpVersion'], order = [ 'ExpVersion', 'observer']) # fixed=['dateStr']    
